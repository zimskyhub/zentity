...
public class EntityListImpl implements EntityList {
    ...
    Iterator<EntityValue> iterator() { return new EntityIterator(); }
    ...
    @Override public @Nonnull
    <T> T[] toArray(@Nonnull T[] ts) { return valueList.toArray(ts); }
    ...
    public static class EmptyEntityList implements EntityList {
        ...
        @SuppressWarnings("unchecked") @Override public @Nonnull
        Object[] toArray() { return new Object[0]; }
        @SuppressWarnings("unchecked") @Override public @Nonnull
        <T> T[] toArray(@Nonnull T[] ts) { return ((T[]) new EntityValue[0]); }
