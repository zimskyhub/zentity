...
import com.zmtech.zframework.entity.EntityDynamicView;
...
public class EntityDynamicViewImpl implements EntityDynamicView {
    ...
    public EntityDynamicViewImpl(EntityFindImpl entityFind) {
        this.efi = entityFind.efi;
    }

    public EntityDynamicViewImpl(EntityFacadeImpl efi) {
        this.efi = efi;
    }

    public EntityDefinition makeEntityDefinition() {
    ...
    public EntityDynamicView addMemberEntity(String entityAlias, String entityName, String joinFromAlias, Boolean joinOptional,
        ...
        if (entityKeyMaps != null && !entityKeyMaps.isEmpty())
    ...
    public EntityDynamicView addRelationshipMember(String entityAlias, String joinFromAlias, String relationshipName,
        ...
        MNode joinFromMemberEntityNode = entityNode.first((MNode it) -> it.getName().equals("member-entity") && it.attribute("entity-alias").equals(joinFromAlias));
        ...
        if (relInfo == null)
            throw new EntityException("动态实体错误: 实体 ["+entityName+"] 的关系 ["+relationshipName+"] 不能存在!");
    ...
    public MNode getViewEntityNode() {
        return entityNode;
    }

    @Override
    public List<MNode> getMemberEntityNodes() {
        return entityNode.children("member-entity");
    }
    ...
    public EntityDynamicView addAlias(String entityAlias, String name, String field, String function, String defaultDisplay) {
        ...
        if (defaultDisplay != null && !defaultDisplay.isEmpty())
            aNode.getAttributes().put("default-display", defaultDisplay);
        return this;
    }

    public MNode getAlias(String name) {
        return entityNode.first("alias", "name", name);
    }
