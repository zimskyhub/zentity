...
public class EntityListIteratorImpl implements EntityListIterator {
    ...
    private final CollectionUtil.MapOrderByComparator orderByComparator;
    ...
    public EntityListIteratorImpl(Connection con, ResultSet rs, EntityDefinition entityDefinition, FieldInfo[] fieldInfoArray,
        ...
        if (txCache != null && queryCondition != null) {
            orderByComparator = obf != null && obf.size() > 0 ? new CollectionUtil.MapOrderByComparator(obf) : null;
    ...
    @Override public EntityValue next() {
        ...
        try {
            if (rs.next()) {
                ...
                if (txCache != null) {
                    WriteMode writeMode = txCache.checkUpdateValue(evb, findAugmentInfo);
    ...
    public void set(EntityValue e) {
        throw new EntityException("EntityListIterator.set() not currently supported");
        // TODO implement this
        // TODO: call EECAs
    ...
    public void add(EntityValue e) {
        throw new EntityException("EntityListIterator.add() not currently supported");
        // TODO implement this
    }
