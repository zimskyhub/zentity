...
import com.zmtech.zkit.exception.ArtifactTarpitException;
...
public class ArtifactExecutionFacadeImpl implements ArtifactExecutionFacade {
    ...
    private void pushInternal(ArtifactExecutionInfoImpl aeii, boolean requiresAuthz, boolean countTarpit) {
    ...
    private String getStackNameString() {
    ...
    public boolean isPermitted(ArtifactExecutionInfoImpl aeii, ArtifactExecutionInfoImpl lastAeii, boolean requiresAuthz, boolean countTarpit,
        ...
        ArtifactExecutionInfoImpl.ArtifactAuthzCheck denyAacv = (ArtifactAuthzCheck) null
