...
public class ArtifactExecutionInfoImpl implements ArtifactExecutionInfo {
    ...
    public void print(Writer writer, int level, boolean children) {
        try {
            ...
            writer.append("[").append(parentAeii != null ? StringUtil.paddedString(getPercentOfParentTime().toPlainString(), 5, false) : "     ").append("%]");
            writer.append("[").append(StringUtil.paddedString(getRunningTimeMillis().toPlainString(), 5, false)).append("]");
            writer.append("[").append(StringUtil.paddedString(getThisRunningTimeMillis().toPlainString(), 3, false)).append("]");
            writer.append("[").append(childList != null ? StringUtil.paddedString(getChildrenRunningTimeMillis().toPlainString(), 3, false) : "   ").append("] ");
            writer.append(StringUtil.paddedString(getTypeDescription(), 10, true)).append(" ");
            writer.append(StringUtil.paddedString(getActionDescription(), 7, true)).append(" ");
            writer.append(StringUtil.paddedString(actionDetail, 5, true)).append(" ");
    ...
    public static List<Map<String, Object>> hotSpotByTime(List<ArtifactExecutionInfoImpl> aeiiList, boolean ownTime, String orderBy) {
        ...
        CollectionUtil.orderMapList(hotSpotList, obList);
        return hotSpotList;
    }
    @SuppressWarnings("unchecked")
    ...
    public static void printHotSpotList(Writer writer, List<Map> infoList) throws IOException {
        ...
        for (Map info: infoList) {
            ...
            writer.append(StringUtil.paddedString(((BigDecimal) info.get("timeMin")).toPlainString(), 7, false)).append(":");
            writer.append(StringUtil.paddedString(((BigDecimal) info.get("timeAvg")).toPlainString(), 7, false)).append(":");
            writer.append(StringUtil.paddedString(((BigDecimal) info.get("timeMax")).toPlainString(), 7, false)).append("]");
            writer.append("[").append(StringUtil.paddedString(((BigDecimal) info.get("count")).toPlainString(), 4, false)).append("] ");
            writer.append(StringUtil.paddedString((String) info.get("type"), 10, true)).append(" ");
            writer.append(StringUtil.paddedString((String) info.get("action"), 7, true)).append(" ");
            writer.append(StringUtil.paddedString((String) info.get("actionDetail"), 5, true)).append(" ");
    ...
    public static void printArtifactInfoList(Writer writer, List<Map> infoList, int level) throws IOException {
        ...
        for (Map info: infoList) {
            ...
            writer.append("[").append(StringUtil.paddedString(((BigDecimal) info.get("time")).toPlainString(), 8, false)).append(":");
            writer.append(StringUtil.paddedString(((BigDecimal) info.get("thisTime")).toPlainString(), 6, false)).append(":");
            writer.append(StringUtil.paddedString(((BigDecimal) info.get("childrenTime")).toPlainString(), 6, false)).append("]");
            writer.append("[").append(StringUtil.paddedString(((BigDecimal) info.get("count")).toPlainString(), 4, false)).append("] ");
            writer.append(StringUtil.paddedString((String) info.get("type"), 10, true)).append(" ");
            writer.append(StringUtil.paddedString((String) info.get("action"), 7, true)).append(" ");
            writer.append(StringUtil.paddedString((String) info.get("actionDetail"), 5, true)).append(" ");
