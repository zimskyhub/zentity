...
public class UrlResourceReference extends ResourceReference {
    ...
    @Override
    public String getLocation() { return locationUrl.toString(); }
    ...
    @Override
    public String getText() { return ObjectUtilities.getStreamText(openStream()); }
    @Override
    public boolean supportsAll() { return isFileProtocol; }
    @Override
    public boolean supportsUrl() { return true; }

    @Override
    public URL getUrl() { return locationUrl; }

    @Override
    public boolean supportsDirectory() { return isFileProtocol; }
    @Override
    ...
    @Override
    public boolean supportsExists() { return isFileProtocol || exists != null; }
    ...
    @Override
    public boolean supportsLastModified() { return isFileProtocol; }
    @Override
    ...
    @Override
    public boolean supportsSize() { return isFileProtocol; }
    @Override
    public long getSize() { return isFileProtocol ? getFile().length() : 0; }

    @Override
    public boolean supportsWrite() { return isFileProtocol; }
    @Override
