...
//        }
    ...
    public static class ArtifactBinInfo {
        ...
        EntityValue makeAhbValue(ExecutionContextFactoryImpl ecfi, Timestamp binEndDateTime) {
            EntityValueBase ahb = (EntityValueBase) ecfi.getEntity().makeValue("moqui.server.ArtifactHitBin");
...
//            ahp.putNoCheck("serverHostName", ecfi.localhostAddress != null ? ecfi.localhostAddress.getHostName() : "localhost");
    ...
    public static class TxStackInfo {
        ...
        public Map<String, XAResource> activeXaResourceMap = new LinkedHashMap<>();
        public Map<String, Synchronization> activeSynchronizationMap = new LinkedHashMap<>();
